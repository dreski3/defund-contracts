...
contract DeFund is Ownable, ERC20 {
    ...
    address priceConsumerAddress = 0xa195ACcEB1945163160CD5703Ed43E4f78176a54; // PriceFeed Oracle Contract
    uint public fee;
    ...
    string symbol_ = "TKN";
    address public _swapperAddr = 0x6212cb549De37c25071cF506aB7E115D140D9e42; // Swapper Contract
    ...
    // by calling the approve function on the token contract (this step should be automted in the front-end)
